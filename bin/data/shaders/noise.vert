...
void main(){
	...
	//generate noise for our color pixel value
	float noiseR = noise( vec2(timeValY * 0.25, pos.y / 2000.0f), 20.0 );
	float noiseG = noise( vec2(timeValY * 0.25, pos.y / 2000.0f), 20.0 );
